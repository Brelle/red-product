...
import { LayoutGrid, Building2, Search, Bell, LogOut } from 'lucide-react'

export default function DashboardLayout() {
  return (
    <div className="flex h-screen font-sans bg-cover bg-center" style={{ backgroundImage: "linear-gradient(rgba(20, 22, 28, 0.75), rgba(20, 22, 28, 0.75)), url('https://res.cloudinary.com/gwhpv6xz/image/upload/v1787306185/94c992138e12276ca66f489ef860cd3e376efe77.jpg')" }}>
      {/* Sidebar */}
      <aside className="w-64 bg-[#2b2f38] text-gray-300 flex flex-col justify-between">
        <div>
          <div className="p-6 flex items-center gap-2 text-white font-bold text-lg tracking-wide border-b border-gray-700/50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 shadow-sm">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 text-gray-400 bg-gray-100 rounded-full px-4 py-2 w-72 focus-within:ring-2 focus-within:ring-gray-300">
              <Search size={18} />
              <input
                type="text"
